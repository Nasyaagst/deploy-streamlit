...
if name:
    ...
    st.write("This dashboard provides data ranging from March 1st 2013 until February 28th 2017 24-hours non-stop about Air Quality in Shunyi, allowing residents and visitors to monitor air quality levels closely. By staying informed about AQI readings, individuals can take appropriate measures to protect their health, such as avoiding outdoor activities during periods of high pollution and using air purifiers indoors.")
